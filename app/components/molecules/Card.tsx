...
const Card = ({ data }: { data: IProject }) => {
  return (
    <motion.figure
      ...
      viewport={{ once: true }}
      className="break-inside-avoid min-w-full min-h-auto max-h-[426px] flex flex-col items-center odd:aspect-video even:aspect-[9/16] shadow-lg hover:shadow-none transition-shadow"
    >
